...
static void fixup11     (expressionS *, unsigned int, int, int);
static void fixup16     (expressionS *, int, int);
static void i51_using   (int);
static void i51_bss     (int);
static void i51_rbss    (int);
static void i51_bbss    (int);
static void i51_ibss    (int);
static void i51_xbss    (int);
static void i51_ebss    (int);
static void i51_bitbss  (int);
static void i51_rdata   (int);
static void i51_bdata   (int);
static void i51_idata   (int);
static void i51_xdata   (int);
static void i51_edata   (int);
static void i51_bitdata (int);
static void i51_eeprom  (int);
static void i51_pcode   (int);
static void i51_bit     (int);
void i51_common (int);
...
/* Opcode hash table.  */
static htab_t i51_hash;
/* Operand hash table.  */
static htab_t i51_operand;
...
md_begin (void)
{
  ...
  i51_hash = str_htab_create ();
  i51_operand = str_htab_create ();
...
md_assemble (char *str)
{
  ...
  opcode = (struct i51_opcodes_s *) str_hash_find (i51_hash, op);
  if (opcode == NULL)
    {
...
static void
i51_bit (int ignore ATTRIBUTE_UNUSED)
{
  expressionS exp;
...
md_undefined_symbol (char *name)
{
  ...
  oper = (struct i51_directop_s *) str_hash_find (i51_operand, op);
  if (oper == NULL) return 0;
  if ((oper->ref == 'D') || (oper->ref == 'B'))
    {
      return (symbol_new (name, absolute_section, &zero_address_frag, oper->value));
    }
  else if (oper->ref == 'U')
    {
      if (regbank == 0xFF)
	{
      ...
      return (symbol_new (name, absolute_section, &zero_address_frag, regbank + oper->value));
    }
  else return 0;
}
...
static void
i51_using (int par ATTRIBUTE_UNUSED)
{
  symbolS *symbolP;
	  ...
	  if (rbss_section == NULL)
	    {
	      ...
	      bfd_set_section_flags (rbss_section, applicable);
	  ...
	  if (bitbss_section == NULL)
	    {
	      ...
	      bfd_set_section_flags (bitbss_section, applicable);
	  ...
	  if (ibss_section == NULL)
	    {
	      ...
	      bfd_set_section_flags (ibss_section, applicable);
	  ...
	  if (xbss_section == NULL)
	    {
	      ...
	      bfd_set_section_flags (xbss_section, applicable);
	  ...
	  if (ebss_section == NULL)
	    {
	      ...
	      bfd_set_section_flags (ebss_section, applicable);
	  ...
	  if (bbss_section == NULL)
	    {
	      ...
	      bfd_set_section_flags (bbss_section, applicable);
...
void
i51_rbss (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (rbss_section == NULL)
    {
...
void
i51_bss (int ignore ATTRIBUTE_UNUSED)
{
  obj_elf_section_change_hook ();
...
void
i51_bbss (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (bbss_section == NULL)
    {
...
void
i51_ibss (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (ibss_section == NULL)
    {
...
void
i51_xbss (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (xbss_section == NULL)
    {
...
void
i51_ebss (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (ebss_section == NULL)
    {
...
void
i51_bitbss (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (bitbss_section == NULL)
    {
...
void
i51_rdata (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (rdata_section == NULL)
    {
      ...
      bfd_set_section_flags (rdata_section, applicable);
    }
  obj_elf_section_change_hook ();
...
void
i51_bdata (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (bdata_section == NULL)
    {
      ...
      bfd_set_section_flags (bdata_section, applicable);
    }
  obj_elf_section_change_hook ();
...
void
i51_idata (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (idata_section == NULL)
    {
      ...
      bfd_set_section_flags (idata_section, applicable);
    }
  obj_elf_section_change_hook ();
...
void
i51_xdata (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (xdata_section == NULL)
    {
      ...
      bfd_set_section_flags (xdata_section, applicable);
    }
  obj_elf_section_change_hook ();
...
void
i51_edata (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (edata_section == NULL)
    {
      ...
      bfd_set_section_flags (edata_section, applicable);
    }
  obj_elf_section_change_hook ();
...
void
i51_bitdata (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (bitdata_section == NULL)
    {
      ...
      bfd_set_section_flags (bitdata_section, applicable);
    }
  obj_elf_section_change_hook ();
...
void
i51_eeprom (int ignore ATTRIBUTE_UNUSED)
{
  flagword applicable;
  if (eeprom_section == NULL)
    {
      ...
      bfd_set_section_flags (eeprom_section, applicable);
    }
  obj_elf_section_change_hook ();
...
void
i51_pcode (int ignore ATTRIBUTE_UNUSED)
{
  char *f;
  unsigned short pflags;
