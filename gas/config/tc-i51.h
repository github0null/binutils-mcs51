...
extern int i51_section_flags (int, int, int);
...
#define TC_PARSE_CONS_RETURN_NONE 0 // 0: exp_mod_none

/*   GAS will call this function for any expression that can not be
     recognized.  When the function is called, `input_line_pointer'
     will point to the start of the expression.  */

TC_PARSE_CONS_RETURN_TYPE i51_parse_cons_expression (expressionS *exp, int nbytes);
...
extern void i51_cleanup (void);
extern void i51_after_pass_hook (void);
