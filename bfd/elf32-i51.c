...
static bool elf32_i51_check_relocs(bfd *, struct bfd_link_info *, asection *,
...
static bool elf32_i51_add_symbol_hook(bfd *, struct bfd_link_info *, Elf_Internal_Sym *,
	   const char **, flagword *, asection **, bfd_vma *);
static bool i51_elf_section_from_shdr (bfd *, Elf_Internal_Shdr *,const char *, int);
static bool i51_elf_fake_sections (bfd *,Elf_Internal_Shdr *,asection *asect);
...
static asection *
elf32_i51_gc_mark_hook (asection *sec,
...
static bool
elf32_i51_gc_sweep_hook (bfd *abfd ATTRIBUTE_UNUSED,
	struct bfd_link_info *info ATTRIBUTE_UNUSED,
	  ...
	  switch (r)
	    ...
	    case bfd_reloc_overflow:
	      info->callbacks->reloc_overflow(info, (h ? &h->root: NULL), name, 
					howto->name, (bfd_vma) 0, input_bfd, input_section, rel->r_offset);
				_abort = false;
	      break;
...
static bool
i51_elf_section_from_shdr (bfd *abfd,
...
static bool
i51_elf_fake_sections (bfd *abfd ATTRIBUTE_UNUSED,
...
bool
elf32_i51_section_from_bfd_section (bfd *abfd ATTRIBUTE_UNUSED,
	asection *sec,
	int *retval)
{

  if (strcmp (bfd_section_name (sec), ".regbank") == 0)
    {
      *retval = SHN_I51_REGBANK;
      return true;
    }
  else if (strcmp (bfd_section_name (sec), ".rbss") == 0)
    {
      *retval = SHN_I51_RDATA_C;
      return true;
    }
  else if (strcmp (bfd_section_name (sec), ".bbss") == 0)
    {
      *retval = SHN_I51_BDATA_C;
      return true;
    }
  else if (strcmp (bfd_section_name (sec), ".ibss") == 0)
    {
      *retval = SHN_I51_IDATA_C;
      return true;
    }
  else if (strcmp (bfd_section_name (sec), ".xbss") == 0)
    {
      *retval = SHN_I51_XDATA_C;
      return true;
    }
  else if (strcmp (bfd_section_name (sec), ".ebss") == 0)
    {
      *retval = SHN_I51_EDATA_C;
      return true;
    }
  else if (strcmp (bfd_section_name (sec), ".bitbss") == 0)
    {
...
void
elf32_i51_symbol_processing (bfd *abfd ATTRIBUTE_UNUSED, asymbol *asym)
{
